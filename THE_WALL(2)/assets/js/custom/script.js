...
document.addEventListener("DOMContentLoaded", function(){
    ...
    signup_btn.addEventListener("click", signinValidation);

    let signin_btn = document.querySelector("#signin_btn");
    signin_btn.addEventListener("click", signupValidation);

    let post_btn = document.querySelector("#post_btn");
    post_btn.addEventListener("click", postForum);

    let signup_page = document.querySelector("#signup_container");
    let signin_page = document.querySelector("#signin_container");
    let dashboard_page = document.querySelector("#dashboard_container")
